	...
	*/
	...
	addNormalMsg:function(message, bAtMsg) {
		...
		$(".diy-msg").append('<li class="margin-bottom hd-grid animated user-message bounceInLeft" msg-id="'+message.message_id+'" user-id="'+
			message.user_id+'" onclick="GUI.showUserInfo('+message.user_id+')"><div class="message" style="background-image:url('+message.headimg+')"><span class="label label-level-1">32</span><span class="text-gray">'+
